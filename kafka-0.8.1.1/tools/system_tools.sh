...
./bin/kafka-console-consumer.sh --zookeeper zk1dg.prod.mediav.com:2191/kafka08 --topic a.s.1 --group console1
...
./bin/kafka-consumer-perf-test.sh  --zookeeper zk1dg.prod.mediav.com:2191/kafka08 --topic a.s.1 --group console2 --show-detailed-stats
# Consumer Offset Checker
./bin/kafka-run-class.sh kafka.tools.ConsumerOffsetChecker --zookeeper zk1dg.prod.mediav.com:2191/kafka08 --topic a.s.1 --group console1 
# Get Offset Shell
...
./bin/kafka-run-class.sh kafka.tools.ExportZkOffsets --zkconnect zk1dg.prod.mediav.com:2191/kafka08 --group console1 --output-file offsets.txt
...
./bin/kafka-run-class.sh kafka.tools.ImportZkOffsets --zkconnect zk1dg.prod.mediav.com:2191/kafka08 --input-file offsets.txt
# Verify Consumer Rebalance
./bin/kafka-run-class.sh kafka.tools.VerifyConsumerRebalance --zookeeper.connect zk1dg.prod.mediav.com:2191/kafka08 --group console1
