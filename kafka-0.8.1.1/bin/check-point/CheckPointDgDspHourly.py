...
broker_list = 'kf34dg.prod.mediav.com:9092,kf35dg.prod.mediav.com:9092,kf36dg.prod.mediav.com:9092'
...
check_point = '/user/hadoop/check_point/dsp_hourly/' + check_time.strftime('%Y-%m-%d/%H')

temp_hdfs_dir = base_dir + '/dsp_hourly/hadoop_offset/' + check_time.strftime('%Y-%m-%d/%H')
